...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_07](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_07.png)


![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_08](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_08.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_09](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_09.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_10](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_10.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_11](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_11.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_12](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_12.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_13](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_13.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_14](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_14.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_15](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_15.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_01](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_01.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_02](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_02.png)

1.  In the **Visual Studio Code** window, right-click or activate the shortcut menu for the Explorer pane, and then select **Open in Terminal**.

![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_03](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_03.png)
...
1. At the open command prompt, enter the following command, and then select Enter to create a new .NET project named **BlobManager** in the current folder:
   ...
   ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_04](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_04.png)
...
1. At the command prompt, enter the following command, and then select Enter to import version 12.0.0 of **Azure.Storage.Blobs** from NuGet:
   ...
   ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_05](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_05.png)
...
1. At the command prompt, enter the following command, and then select Enter to build the .NET web application:
   ...
   ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_06](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_06.png)
...
1. Observe the output from the currently running console application. The output contains metadata for the Storage account that was retrieved from the service.
   ...
   ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_16](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_16.png)
...
1. Observe the output from the currently running console application. The updated output includes a list of every existing container in the account.
   ...
   ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_17](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_17.png)
...
1. Observe the output from the currently running console application. The updated output includes metadata about the existing container and blobs.
   ...
   ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_18](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_18.png)
...
1. Observe the output from the currently running console application. The updated output includes metadata about the existing container and blobs.
   ...
   ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_19](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_19.png)
...
1.	In the **Upload blob** window, perform the following actions:
    ...
    ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_20](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_20.png)
    
    ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_21](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_21.png)
...
1. Observe the output from the currently running console application. The updated output includes the final URL to access the blob online. Record the value of this URL to use later in the lab.
   ...
   ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_22](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_22.png)
...
![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_23](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_23.png)
...
1.  At the command prompt, enter the following command, and then select Enter to delete the **StorageMedia** resource group:
    ...
    ![Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_24](images/Lab-Retrieving_Azure_Storage_resources_and_metadata_by_using_the_Azure_Storage_SDK_for_NET_24.png)
