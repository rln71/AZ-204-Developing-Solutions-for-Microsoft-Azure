...
1. Select the **Go to resource** button on the **Deployment** blade to go to the newly created storage account.
   ...
   ![](images/Lab-AsynchronouslyMessagesByQueues_01.png)
...
![](images/Lab-AsynchronouslyMessagesByQueues_02.png)
...
1. At the command prompt, enter the following command, and then select Enter to build the .NET web application:
   ...
   Primero he creado la carpeta en el sistema de ficheros - he usado otro nombre poniendo el prefijo arbitrario Code - después he abierto el *VisualStudio Code* y desde **File** he abierto la carpeta anterior. Después abro la consola de *VisualStudio Code* con **Ctrl + ñ** y escribo los comandos indicados:
   ...
   En el comando `dotnet new console` no indico el nombre del proyecto para que lo coja del propio nombre de la carpeta. Y en el comando `dotnet add package` no informa el número de versión para que coja la más reciente.

   ![](images/Lab-AsynchronouslyMessagesByQueues_03.png)
...
![](images/Lab-AsynchronouslyMessagesByQueues_04.png)
...
![](images/Lab-AsynchronouslyMessagesByQueues_05.png)
...
1. At the open command prompt, enter the following command, and then select Enter to build the .NET web application:
   ...
   ![](images/Lab-AsynchronouslyMessagesByQueues_06.png)
...
1. Observe the output from the currently running console application. The output indicates that no messages are in the queue.
   ...
   ![](images/Lab-AsynchronouslyMessagesByQueues_07.png)
...
1. In the **Add Message** pop-up window, perform the following actions:
   ...
   1. Ensure that the **Encode message body in Base 64** check box isn't selected.
      ...
      ![](images/Lab-AsynchronouslyMessagesByQueues_08b.png)

   1.  Select **OK**.

   ![](images/Lab-AsynchronouslyMessagesByQueues_09.png)
...
1. Observe the output from the currently running console application. The output includes the new message that you created.
   ...
   ![](images/Lab-AsynchronouslyMessagesByQueues_10.png)
...
1. Observe the output from the currently running console application. The message that you created earlier in the lab still exists because it hasn't been deleted previously.
   ...
   ![](images/Lab-AsynchronouslyMessagesByQueues_11.png)
...
![](images/Lab-AsynchronouslyMessagesByQueues_12.png)
...
1. Observe the output from the currently running console application. The content of the new message that you sent should be in the output.
   ...
   ![](images/Lab-AsynchronouslyMessagesByQueues_13.png)
...
![](images/Lab-AsynchronouslyMessagesByQueues_14.png)
...
1. Close the Cloud Shell pane in the portal.
   ...
   ![](images/Lab-AsynchronouslyMessagesByQueues_15.png)
