...
1. At the **Cloud Shell** command prompt in the portal, perform the following actions:
    ...
    ![](images/Lab-PublishingSubscribingEventGridEvents_01.png)
...
![](images/Lab-PublishingSubscribingEventGridEvents_02.png)
...
1. On the **Docker** tab, perform the following actions:
    ...
    1. In the **Image and tag** text box, enter **microsoftlearning/azure-event-grid-viewer:latest**.
       ...
       Esa imagen se encuentra en **DockerHub** y se puede buscar por **azure-event-grid-viewer**.
...
![](images/Lab-PublishingSubscribingEventGridEvents_03.png)
...
1. In the **Properties** section, record the value of the **URL** text box. You'll use this value later in the lab.
    ...
    ![](images/Lab-PublishingSubscribingEventGridEvents_04.png)
...
1. Observe the currently running **Azure Event Grid viewer** web application. Leave this web application running for the remainder of the lab.
    ...
    ![](images/Lab-PublishingSubscribingEventGridEvents_05.png)
...
![](images/Lab-PublishingSubscribingEventGridEvents_06.png)
...
1. Select the event and review its JSON content.
   ...
   ![](images/Lab-PublishingSubscribingEventGridEvents_07.png)
...
1. On the **Event Grid Topic** blade, record the value of the **Topic Endpoint** field. You'll use this value later in the lab.
   ...
   ![](images/Lab-PublishingSubscribingEventGridEvents_08.png)
...
1. In the **Access keys** section, record the value of the **Key 1** text box. You'll use this value later in the lab.
   ...
   ![](images/Lab-PublishingSubscribingEventGridEvents_09.png)
...
En el sistema de ficheros creo una carpeta nueva y vacía a la que llamo **CodeEventPublisher**. Abro *VisualStudio Code* y desde el menú **File/Open Folder...** abro dicha carpeta. Abro la consola con **Ctrl + ñ** y escribo los siguientes comandos para crear el proyecto, añadir la versión más reciente del package que se necesita, y compilar.
...
1. At the command prompt, enter the following command, and then select Enter to import version 4.1.0 of **Azure.Messaging.EventGrid** from NuGet:
    ...
    ![](images/Lab-PublishingSubscribingEventGridEvents_10.png)
...
![](images/Lab-PublishingSubscribingEventGridEvents_11.png)
...
1. Save the **Program.cs** file.
    ...
    ![](images/Lab-PublishingSubscribingEventGridEvents_12.png)
...
1. Observe the success message output from the currently running console application.
    ...
    ![](images/Lab-PublishingSubscribingEventGridEvents_13.png)
...
1. Review the **Employees.Registration.New** events that were created by your console application.
   ...
   ![](images/Lab-PublishingSubscribingEventGridEvents_14.png)

1. Select any of the events and review its JSON content.

   ![](images/Lab-PublishingSubscribingEventGridEvents_15.png)
