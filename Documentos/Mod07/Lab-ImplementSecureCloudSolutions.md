...
1. Select **Create** to create the storage account by using your specified configuration.
    ...
    ![Lab-ImplementSecureCloudSolutions_01](images/Lab-ImplementSecureCloudSolutions_01.png)
...
![Lab-ImplementSecureCloudSolutions_02](images/Lab-ImplementSecureCloudSolutions_02.png)
...
![](images/Lab-ImplementSecureCloudSolutions_03.png)
...
![](images/Lab-ImplementSecureCloudSolutions_04.png)
...
![](images/Lab-ImplementSecureCloudSolutions_05.png)
...
1. In the **Secrets** pane, select **Generate/Import**.
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_06.png)
...
1. From the **Create a secret** blade, perform the following actions:
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_07.png)
...
![](images/Lab-ImplementSecureCloudSolutions_08.png)
...
1. In the Access policies pane, select **Add Access Policy**.
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_09.png)
...
1. From the **Add access policy** blade, perform the following actions:
    ...
    1. From the **Principal** blade, find and then select the service principal named **securefunc[yourname]**, and then select **Select**.
        ...
        ![](images/Lab-ImplementSecureCloudSolutions_10.png)
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_11.png)
...
1. From the **ConfidentialStack** blade, select the **securefunc[yourname]** function app that you created earlier in this lab.
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_12.png)
...
1. From the **Configuration** pane, perform the following actions:
    1. Select the **Application settings** tab, and then select **New application setting**.
        ...
        ![](images/Lab-ImplementSecureCloudSolutions_13.png)
    ...
    1. Leave the **deployment slot setting** text box set to its default value.
        ...
        ![](images/Lab-ImplementSecureCloudSolutions_14.png)
...
Creo una carpeta vacía en mi sistema de ficheros a la que he llamado **funccodeproject**, y desde la consola de *VisualStudio Code* voy navegando a esa carpeta con el comando **cd**.

![](images/Lab-ImplementSecureCloudSolutions_15.png)

Introduzco los comandos anteriores y compilo, y ya podré abrir la carpeta **funccodeproject** con el proyecto desde el menú **File**.

![](images/Lab-ImplementSecureCloudSolutions_16.png)

![](images/Lab-ImplementSecureCloudSolutions_17.png)
...
1. Still in the open command prompt, enter the following command, and then select Enter to use the **Azure Functions Core Tools** to create a new function named **FileParser** using the **HTTP trigger** template:
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_18.png)
    
    ![](images/Lab-ImplementSecureCloudSolutions_19.png)
...
1. Select **Save** to save your changes to the **FileParser.cs** file.
     ...
     ![](images/Lab-ImplementSecureCloudSolutions_20.png)
...
1. Observe the **[TEST VALUE]** value of the **StorageConnectionString** being returned as the result of the HTTP request:
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_21.png)
...
1. In the **Microsoft Edge** browser window, perform the following actions:
    ...
    1. Enter the password for your Microsoft account, and then select **Sign in**.
       ...
       ![](images/Lab-ImplementSecureCloudSolutions_22.png)
    
1. Return to the currently open **Windows Terminal** window. Wait for the sign-in process to finish.

    ![](images/Lab-ImplementSecureCloudSolutions_23.png)
...
1. Close the currently running **Windows Terminal** application.
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_24.png)
...
![](images/Lab-ImplementSecureCloudSolutions_25.png)
...
1. From the **Blob** blade, find the blob metadata, and then copy the URL for the blob.
     ...
     ![](images/Lab-ImplementSecureCloudSolutions_26.png)
...
1. The JavaScript Object Notation (JSON) contents of the blob should now display. Close the browser window with the JSON contents.
     ...
     ![](images/Lab-ImplementSecureCloudSolutions_27.png)
...
1. In the **Change access level** pop-up window, perform the following actions:
    ...
    1. Select **OK**.
       ...
       ![](images/Lab-ImplementSecureCloudSolutions_28.png)
...
![](images/Lab-ImplementSecureCloudSolutions_29.png)
...
1. Select **Save** to save your changes to the **FileParser.cs** file.
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_30.png)
...
1. Enter the following command, and then select Enter to publish the function app project again:
    ...
    ![](images/Lab-ImplementSecureCloudSolutions_31.png)
...
![](images/Lab-ImplementSecureCloudSolutions_32.png)
